...
<template>
    ...
    <div class="px-5 py-3 md:px-10 md:py-6 xl:px-40 xl:py-12 flex flex-col gap-y-6">
        <div class="flex items-center justify-between">
            ...
            <h2 class="text-2xl font-bold">Adicionar um contato</h2>
            <div></div> <!-- Placeholder para alinhamento -->
        </div>
        <form action="" @submit.prevent="handleSubmit" class="flex flex-col gap-y-6">
            ...
            <div class="w-full flex justify-end">
                <Button class="w-full md:w-auto" type="submit" :disabled="form.processing"> Adicionar contato</Button>
            </div>
        </form>
    </div>
</template>